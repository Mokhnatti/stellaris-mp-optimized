...
В правом нижнем углу лаунчера видна шестизначная строка — **запиши**.
...
У тебя **должен быть точно такой же** `3e40`. Если другой — что-то не так:
...
В субботу в лобби MP **снова сверим** — у всех 3 должен быть одинаковый.
